...
import { C as isNotFound, S as rootRouteId, T as invariant, _ as resolveManifestAssetLink, b as isResolvedRedirect, i as RouterProvider, t as renderRouterToStream, v as executeRewriteInput, x as parseRedirect, y as isRedirect } from "../_libs/@tanstack/react-router+[...].mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CI1uzL3D.mjs");
...
//#endregion
export { ssr_exports as a, getServerFnById as i, createServerFn as n, getRequestHeaders as r, TSS_SERVER_FUNCTION as t };
