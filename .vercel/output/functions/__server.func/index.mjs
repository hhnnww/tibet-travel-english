...
import { a as NodeResponse, n as HTTPError, o as toNodeHandler, r as defineLazyEventHandler, t as H3Core } from "./_libs/h3+rou3+srvx.mjs";
...
var _lazy_EHp2Gz = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
var findRoute = /* @__PURE__ */ (() => {
	const data = {
		route: "/**",
		handler: _lazy_EHp2Gz
	};
	return ((_m, p) => {
		return {
			data,
