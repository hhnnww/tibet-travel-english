...
import { $ as init_dist_es$2, Ct as require_client, Dt as init_dist_es$1, F as init_dist_es, Ot as HttpRequest, Q as dist_es_exports$1, R as CredentialsProviderError, ft as init_dist_es$3, gt as NodeHttpHandler, ht as init_dist_es$4, pt as sdkStreamMixin } from "./client-s3+[...].mjs";
...
async function getCredentials(response, logger) {
	...
	if (response.statusCode === 200) {
		...
		return {
			...
			expiration: (0, dist_es_exports$1.parseRfc3339DateTime)(parsed.Expiration)
		};
	}
